...
export class PrismaService implements OnModuleInit, OnModuleDestroy {
  ...
  get egg() {
    return this.client.egg;
  }
  get location() {
    return this.client.location;
  }
  get package() {
    return this.client.package;
  }
  get userResources() {
    return this.client.userResources;
  }
  get node() {
  ...
  get storeItem() {
    return this.client.storeItem;
  }
  get passkey() {
    return this.client.passkey;
  }
  get oAuthAccount() {
    return this.client.oAuthAccount;
  }
  get ticket() {
    return this.client.ticket;
  }
  get ticketMessage() {
    return this.client.ticketMessage;
  }
